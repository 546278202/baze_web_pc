    ...
    <div style="background:#f4f4f4;">
        ...
        <div  class="course-info" style="height:135px;border:1px solid #eaedec;padding: 20px 20px;box-sizing: border-box;" >
            ...
            <div style="float:left;margin-right: 20px;">
                <img v-if="data.sCourseImg" :src="Global.img_BASE_URL+data.sCourseImg" style="width:158px;height:90px;" :onerror="Global.defalutLogoUrl"/>
            </div>

            <div style="float:left;">
                <div
                style="margin-bottom: 40px; font-size: 16px; font-weight: 400;">{{data.sCourseName}}
                </div>
                <div style="color: #999; font-size: 14px;">1门课程</div>
            </div>
            <div style="font-size: 18px;font-weight: 500;  color: #eb5144;float:right;height: 94px;line-height: 94px;margin-right: 100px;"> ￥{{data.DisPrice}} </div> </div>
        </div>
        </div>
        ...
        <div class="order-pay">
			...
			<div class="course-info" style="padding: 20px 0;box-sizing: border-box;">
				<div style="float:left;margin-right: 200px;">   订单金额 ：{{data.DisPrice}} </div>
				<div style="float:left;margin-right: 200px;">  优惠金额：0.00 </div>
				<div style="float:left;margin-right: 200px;"> 应付金额：{{data.DisPrice}} </div>
			</div>
        </div>
        <div class="order-pay">
        ...
        <div class="course-info" style="padding: 20px 0;box-sizing: border-box;overflow: hidden;">
            <div style="float:right;">
				<div style="float:left;color: #999;font-size: 14px;text-align: center;margin-right:20px;line-height: 50px;">
					<span>应付金额：</span><span style="font-size: 24px;color: #eb5144;">￥{{data.DisPrice}}</span>
				</div>
 	...
 	methods: {
		...
		getOrderDetail() {
            ...
            this.axios.get(this.Global.BASE_URL + `/index.php?r=web/site/orderinfo`, { params: params }).then(response => {
				this.data=response.data.course
