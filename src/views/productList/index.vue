  ...
  <div>
    <div class="productList" ref="productList" style="background:#F4F4F4;">
        ...
        <div class="main" ref="main">
            <NavigationCourseFilter @fatherMethod="fatherMethod" :BreadList="['录播列表']"></NavigationCourseFilter>
            <div class="class-list" id="class-list">
                <div class="item">
                    ...
                    <div style="position:relative;width:100%;min-height:500px;" v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(244, 244, 244)">
                        <ol style="overflow:hidden;min-height: 500px;position: relative;">
                            <li v-for="(item,index) in dataList" :key="index">
                                <router-link :to="{ path: '/videoDetail' , query:{id:item.id}}">
                                    <div class="video-top">
                                        <img :src="Global.img_BASE_URL+item.sCourseImg" @mouseover="enter($event)" @mouseleave="leave($event)" :onerror="Global.defalutLogoUrl">      
...
export default {
  ...
  data() {
    ...
    methods: {
        ...
        getDataList(params){
            this.loading=true
            this.axios.get(this.Global.BASE_URL + `/index.php?r=web/site/courseindex`,{ params: params }).then(response => {
